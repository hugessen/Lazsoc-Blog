...
@NgModule({
  ...
  providers: [WebAPI, Angular2TokenService, AwsService, AuthService, AuthGuard, ClubDetailResolve, CanDeactivateUpdate, {provide: LocationStrategy, useClass: HashLocationStrategy}],
